						...
						<div class="blog-post-inner">
							...
							<div class="post-info">
								...
								<div class="middle-area">
									...
									<h6 class="date"><?=$article[0]->date()?></h6>
								</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="card h-100">
						<div class="single-post post-style-1">
							...
							<div class="blog-image"><img src="public/images/alex-lambley-205711.jpg" alt="Blog Image"></div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="card h-100">
						<div class="single-post post-style-1">
							...
							<div class="blog-image"><img src="public/images/caroline-veronez-165944.jpg" alt="Blog Image"></div>
